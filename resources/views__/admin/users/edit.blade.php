    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('relationPreference') ? 'is-invalid' : '' }}" name="relationPreference" id="relationPreference" required>
                    <option value disabled {{ old('relationPreference', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                    @foreach(App\Models\User::RELATION_PREFERENCE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('relationPreference', $user->relationPreference) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('relationPreference'))
                    <span class="text-danger">{{ $errors->first('relationPreference') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('favDrink') ? 'is-invalid' : '' }}" type="text" name="favDrink" id="favDrink" value="{{ old('favDrink', $user->favDrink) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('favSong') ? 'is-invalid' : '' }}" type="text" name="favSong" id="favSong" value="{{ old('favSong', $user->favSong) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('petPeeve') ? 'is-invalid' : '' }}" type="text" name="petPeeve" id="petPeeve" value="{{ old('petPeeve', $user->petPeeve) }}" required>
