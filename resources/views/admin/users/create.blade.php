    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('relation_preference') ? 'is-invalid' : '' }}" name="relationPreference" id="relation_preference" required>
                    ...
                    @foreach(App\Models\User::RELATION_PREFERENCE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('relation_preference', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fav_drink') ? 'is-invalid' : '' }}" type="text" name="favDrink" id="fav_drink" value="{{ old('fav_drink', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fav_song') ? 'is-invalid' : '' }}" type="text" name="favSong" id="fav_song" value="{{ old('fav_song', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('my_dislikes') ? 'is-invalid' : '' }}" type="text" name="petPeeve" id="my_dislikes" value="{{ old('my_dislikes', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('user_status') ? 'is-invalid' : '' }}" name="user_status" id="user_status" required>
                    ...
                    @foreach(App\Models\User::USER_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('user_status', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
